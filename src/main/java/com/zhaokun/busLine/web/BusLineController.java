...
public class BusLineController {
    ...
    public void searchByBusLine(HttpServletResponse response, HttpServletRequest request, Model model) throws IOException {
        ...
        String limit = request.getParameter("limit");
        String offset = request.getParameter("offset");
        String busLineName = request.getParameter("busLineName");
        Gson gson = new Gson();
        BusLinePage busLinePage = new BusLinePage();
        Collection<BusLine> ints = busLineRepository.findByBusLineName(busLineName, limit, offset);
        busLinePage.setRows(ints);
        Collection<BusLine> length = busLineRepository.findByBusLineName(busLineName);
        busLinePage.setTotal(length.size() + "");
        System.out.println(gson.toJson(busLinePage));
        response.getWriter().write(gson.toJson(busLinePage));
    }
    ...
    public void searchByBusStation(HttpServletResponse response, HttpServletRequest request, Model model) throws IOException {
        ...
        String limit = request.getParameter("limit");
        String offset = request.getParameter("offset");
        String busStation = request.getParameter("busStation");
        Gson gson = new Gson();
        BusLinePage busLinePage = new BusLinePage();
        Collection<BusLine> ints = busLineRepository.findByBusStation(busStation, limit, offset);
        busLinePage.setRows(ints);
        Collection<BusLine> length = busLineRepository.findByBusStation(busStation);
        busLinePage.setTotal(length.size() + "");
        System.out.println(gson.toJson(busLinePage));
        response.getWriter().write(gson.toJson(busLinePage));
    }
    ...
    public void searchByStartAndEnd(HttpServletResponse response, HttpServletRequest request, Model model) throws IOException {
        ...
        Gson gson = new Gson();
        BusLinePage busLinePage = new BusLinePage();
        Collection<BusLine> ints = busLineRepository.findByStartAndEnd(startStation, endStation, limit, offset);
        busLinePage.setRows(ints);
        Collection<BusLine> length = busLineRepository.findByStartAndEnd(startStation, endStation);
        busLinePage.setTotal(length.size() + "");
        System.out.println(gson.toJson(busLinePage));
        response.getWriter().write(gson.toJson(busLinePage));
    }
    ...
    @RequestMapping(value = "/busLineDetail", method = RequestMethod.GET)
    public String busLineDetail(HttpServletResponse response, HttpServletRequest request, Model model) throws IOException {
        response.setCharacterEncoding("UTF-8");
        System.out.println(request.getParameter("limit"));
        System.out.println(request.getParameter("offset"));
        String limit = request.getParameter("limit");
