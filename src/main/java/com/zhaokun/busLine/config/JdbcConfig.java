...
public class JdbcConfig {
    ...
    @Bean
    public JdbcBusLineRepository jdbcBusLineRepository(DataSource dataSource) {
        JdbcBusLineRepository jdbcBusLineRepository = new JdbcBusLineRepository();
        jdbcBusLineRepository.setDataSource(dataSource);
        return jdbcBusLineRepository;
    }
